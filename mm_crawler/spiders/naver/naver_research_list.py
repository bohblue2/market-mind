...
from mm_crawler.items.naver import NaverResearchItem
...
class NaverResearchBase(DomainPipelineSpider):
...
class NaverResearchMarketInfo(NaverResearchBase):
    ...
    _get_target_url = lambda _, page: (
        f"https://finance.naver.com/research/market_info_list.naver?&page={page}"
    )  # type: ignore

    async def _inner_parse(self, response: HtmlResponse) -> List[NaverResearchItem]:
        reports_list_xpath = response.xpath(
            "/html/body/div[3]/div[2]/div[2]/div[1]/div[2]/table[1]"
        ).get()
...
class NaverResearchCompanyList(NaverResearchBase):
    ...
    _get_target_url = lambda self, page: (
        f"https://finance.naver.com/research/company_list.naver?&page={page}"
    )  # type: ignore
...
class NaverResearchDebentureList(NaverResearchBase):
    ...
    _get_target_url = lambda _, page: (
        f"https://finance.naver.com/research/debenture_list.naver?&page={page}"
    )  # type: ignore
...
class NaverResearchEconomyList(NaverResearchBase):
    ...
    _get_target_url = lambda _, page: (
        f"https://finance.naver.com/research/economy_list.naver?&page={page}"
    )  # type: ignore
...
class NaverResearchIndustryList(NaverResearchBase):
    ...
    _get_target_url = lambda _, page: (
        f"https://finance.naver.com/research/industry_list.naver?&page={page}"
    )  # type: ignore
...
class NaverResearchInvestList(NaverResearchBase):
    ...
    _get_target_url = lambda _, page: (
        f"https://finance.naver.com/research/invest_list.naver?&page={page}"
    )  # type: ignore
